...
export default function Main() {
  ...
  const filmes: FilmesType[] = [
    ...
    },
    {
      ...
      sinopse:
        "Butterfly se torna a embaixadora real de Flutterfield e é enviada para estabelecer a paz entre sua terra encantada e seus rivais. Apesar de não causar uma boa impressão no rei, ela faz amizade com a tímida filha do monarca, a princesa Catania.",
    ...
    {
        id:5,
        titulo:"Barbie Em Vida de Sereia 2",
    ...
    {
        id:6,
        titulo:"Barbie e O Portal Segreto",
         sinopse:"  tímida princesa Alexa descobre um portal secreto e entra em uma terra desconhecida. Após conhecer Romy e Nori, uma sereia e uma fada, Alexa descobre seus poderes mágicos e as três decidem deter a malvada Malucia.",
        imagem:"/portal segreto.jpg"
    },
    {
        id:7,
        titulo:"Barbie A Sereia das Pérolas",
         sinopse:" Barbie é Lumina uma linda sereia, que sonha em ser uma princesa. Desde pequena, Lumina tem um poder mágico de fazer as pérolas dançarem e brilharem. Ela e sua melhor amiga Tuca, um cavalo-marinho cor-de-rosa, embarcam em uma aventura ao fantástico reino das sereias.",
